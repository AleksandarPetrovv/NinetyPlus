...
function MatchDetailsModal({ match, isOpen, onClose }) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 flex items-center justify-center p-4 z-50">
      <div className={`bg-dark-200 rounded-xl ${isFullscreen ? 'fixed inset-0 z-60 rounded-none' : 'max-w-3xl w-full'} p-6 max-h-[90vh] overflow-y-auto border border-dark-300`}>
      {error ? (
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-gray-400">
                    {formatBulgarianTime(match.utcDate)}
                  </p>
                </div>
                <button 
                  onClick={onClose} 
                ...
                <div className="flex justify-center items-center space-x-8 text-center">
                  ...
                  <div className="flex flex-col items-center">
                    <a 
                      ...
                      className={`flex items-center px-4 py-2 rounded-lg transition-colors duration-200 text-sm -mt-28 mb-8
